...
export const translations = {
    fr: {
        ...
        contact: {
            ...
            subtitle: "Un projet en tête ? Landing page, site professionnel ou boutique en ligne ? Je transforme vos idées en expériences web modernes et performantes.",
            sendMessage: "Envoyer un message",
            successTitle: "Merci ! 🙏",
            successMessage: "Votre message a bien été envoyé. Je reviendrai vers vous rapidement !",
            anotherMessage: "Envoyer un autre message",
            getInTouch: "Me contacter",
            getInTouchText: "Toujours motivé par de nouveaux défis et collaborations. Discutons de vos idées ou de votre projet dès maintenant.",
            email: "E-mail",
            location: "Localisation",
            worldwide: "Disponible dans le monde entier",
            emailMe: "M'écrire directement",
        },
        footer: {
            slogan: "Création d'expériences numériques exceptionnelles",
  ...
  /************************************ENGLISH TRADUCTION******************************** */
    en: {
        ...
        contact: {
            ...
            subtitle: "Have a project in mind? Whether it's a landing page, a business site or a full e-commerce platform. I'm here to turn your ideas into fast, modern, and animated web experiences.",
            ...
            getInTouchText: "I'm always excited to take on new challenges and collaborate on innovative projects. Whether you need a complete website or just want to discuss ideas, I'm here to help.",
            email: "Email",
            location: "Location",
        ...
        footer: {
            slogan: "Crafting exceptional digital experiences",
